...
# 客户端激活/心跳（带证书校验）
./build/license_client activate --host 127.0.0.1 --port 8088 --machine my-lora-node --cache ./license_cache.txt --tls-ca ./certs/server.crt
./build/license_client run --host 127.0.0.1 --port 8088 --machine my-lora-node --cache ./license_cache.txt --grace 20 --tls-ca ./certs/server.crt
```
